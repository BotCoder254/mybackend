    ...
    <div className="min-h-screen flex">
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-[#AA60C8] items-center justify-center">
        ...
        >
          ...
          <p className="text-xl">Your secure backend solution</p>
        </motion.div>
      </div>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center bg-[#FFDFEF] p-8">
        ...
        >
          <h2 className="text-3xl font-bold text-[#AA60C8] mb-8 text-center">Sign In</h2>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="flex items-center justify-between">
              ...
              <Link to="/forgot-password" className="text-sm text-[#AA60C8] hover:text-[#D69ADE]">
                Forgot password?
              </Link>
            </div>
          ...
          <div className="mt-6">
            <div className="relative">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="px-2 bg-[#FFDFEF] text-gray-500">Or continue with</span>
              </div>
            </div>
          ...
          <p className="mt-8 text-center text-sm text-gray-600">
            ...
            <Link to="/signup" className="font-medium text-[#AA60C8] hover:text-[#D69ADE]">
              Sign up
            </Link>
          </p>
        </motion.div>
